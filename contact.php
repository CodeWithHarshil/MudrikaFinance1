...
<head>
    ...
    <title>Contact || Mudrika Finance ||</title>
    <!-- favicons Icons -->
                    ...
                    <div class="main-menu-wrapper__right">
                        <div class="main-menu-wrapper__search-box">
                            ...
                            <div id="divaa2">
                                ...
                                <input id="btnb2" type="button" value="Hindi" onclick="window.location.href='Hindi/contact_hindi.php';">
                              </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="contact-info__single">
                            ...
                            <p class="contact-info__text">We are offering Personal loans, Gold loans and Home loans under various government projects and digital bank account opening through our platform.
                            </p>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        ...
                        <div class="contact-info__single">
                            ...
                            <p class="contact-info__text">JP Tower, Ganga Sagar-B, Vaishali Nagar 302021 Jaipur, Rajasthan
                                <br><br><br><br><br>
                            </p>
                        </div>
                    </div>
