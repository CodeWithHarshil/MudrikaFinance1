...
<head>
    ...
    <title>आजीविका || मुद्रिका फाइनेंस</title>
    <!-- favicons Icons -->
...
<body>
                    ...
                    <div class="main-menu-wrapper__right">
                        <div class="main-menu-wrapper__search-box">
                            ...
                            <div id="divaa2">
                                ...
                                <div id="divaaa2"></div>
                                <input id="btnb2" type="button" value="Hindi" onclick="window.location.href='career_hindi.php';">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="container1 wow bounceInRight" data-wow-duration="2s">
                    <div class="inputs">
                        ...
                        <div class="brand-title">नौकरी के लिए आवेदन करे</div>
                        <div class="grid">
                            <div class="grid1">
                            ...
                            <div class="grid1">
                                ...
                                <!-- <div class="input-box"> -->
                                <input type="file" name="file" id="file" class="form-control" placeholder="Upload CV"required>
                            </div>
                        </div>
    ...
    <a href="contact_hindi.php" data-target="html" class="scroll-to-top"><i class="fa fa-phone"></i></a>
